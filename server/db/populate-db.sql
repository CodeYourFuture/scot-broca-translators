...
INSERT INTO documents (name, from_language_code, to_language_code, status, submission_date, due_date, owner_id, format, content) values ('University Transcript','zh-cn','en', 'Processing', '2019-10-08',NOW() - INTERVAL '10 DAY', 'a2deeae9-1d8c-44ef-a187-a85dfa56fee8', 'Text', E'战国时期，靠近北部边城，住着一个老人，名叫塞翁。塞翁养了许多马，一天，
...
INSERT INTO documents (name, from_language_code, to_language_code, status, submission_date, due_date, owner_id, format, content) values ('High School Diploma', 'es','en', 'Waiting', '2019-10-08',NOW() - INTERVAL '15 DAY','a2deeae9-1d8c-44ef-a187-a85dfa56fee8','Text', E'Hola, este es mi diploma por favor ayúdame a traducir y te daré un fuerte abrazo.
De todas las numerosas palabras que figuran en dicha comunicación,
tan sólo un párrafo breve está dedicado a esa cuestión,');

INSERT INTO documents (name, from_language_code, to_language_code, status, submission_date, due_date, owner_id, format, content) values ('Bank Statement', 'es','fr', 'Waiting', '2019-10-08',NOW() + INTERVAL '30 DAY','a2deeae9-1d8c-44ef-a187-a85dfa56fee8','Text', E'Wikipedia define un extracto bancario como "un resumen de las transacciones financieras que tienen
...
INSERT INTO documents (name, from_language_code, to_language_code, status, submission_date, due_date, owner_id, format, content) values ('Transcript', 'zh-cn','en', 'Waiting', '2019-10-08',NOW() - INTERVAL '1 DAY','a2deeae8-1d8c-44ef-a187-a86dfa56fee9','Text', E'如果您正在欧洲大学申请课程，大多数机构会要求您提供成绩单。但是，某些机构可能会要求您提供文凭补充。本文档包括学术成绩单，一份根据欧洲学分转移计划（ECTS）学分量化您的课程的声明以及描述高等教育系统的其他信息。
